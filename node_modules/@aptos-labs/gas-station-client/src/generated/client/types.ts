...
export interface Client<Req = Request, Res = Response, Err = unknown, Options = RequestOptions> {
  connect: MethodFn;
  delete: MethodFn;
  get: MethodFn;
  getConfig: () => Config;
...
export type Options<T = unknown, ThrowOnError extends boolean = boolean> = T extends { body?: any }
