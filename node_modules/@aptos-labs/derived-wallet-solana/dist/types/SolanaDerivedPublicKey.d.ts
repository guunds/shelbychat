import { AccountPublicKey, AptosConfig, AuthenticationKey, Deserializer, HexInput, Serializer, Signature, VerifySignatureArgs, PublicKey } from "@aptos-labs/ts-sdk";
...
export declare class SolanaDerivedPublicKey extends AccountPublicKey {
    ...
    static isInstance(value: PublicKey): value is SolanaDerivedPublicKey;
}
